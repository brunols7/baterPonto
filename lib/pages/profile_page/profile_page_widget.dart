...
class _ProfilePageWidgetState extends State<ProfilePageWidget>
  ...
  void initState() {
    ...
    _model.nomeUsuarioTextController1 ??=
    ...
    _model.nomeUsuarioTextController2 ??=
        TextEditingController(text: currentUserDisplayName);
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title: Text(
                                                                'Cancelar alteração'),
                                                            content: Text(
                                                                'Deseja remover a alteração da imagem ?'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
                                  ...
                                  Padding(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => TextFormField(
                                        controller:
                                            _model.nomeUsuarioTextController1,
                                        focusNode: _model.nomeUsuarioFocusNode1,
                                        autofocus: false,
                                        obscureText: false,
                                        ...
                                        children: [
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .empresaTextTextController,
                                                focusNode:
                                                    _model.empresaTextFocusNode,
                                                autofocus: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                ...
                                                cursorColor:
                                                    FlutterFlowTheme.of(context)
                                                        .primary,
                                                validator: _model
                                                    .empresaTextTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ),
                                          InkWell(
                                            ...
                                            highlightColor: Colors.transparent,
                                            onTap: () async {
                                              if (_model.empresaTextTextController
                                                          .text !=
                                                      null &&
                                                  _model.empresaTextTextController
                                                          .text !=
                                                      '') {
                                                await currentUserReference!
                                                    .update({
                                  ...
                                  Padding(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => TextFormField(
                                        controller:
                                            _model.nomeUsuarioTextController2,
                                        focusNode: _model.nomeUsuarioFocusNode2,
                                        autofocus: false,
                                        readOnly: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primary,
                                        validator: _model
                                            .nomeUsuarioTextController2Validator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
